...
同学们将在以下命题中的功能性和美观性题目中 **分别各选择至少一个命题** 来实现（即在功能性题目中至少选择一个题目、美观性题目中至少选择一个题目），多者不限但不会获得额外的分数。
...
> **任务 5.1（T5.1）**
>
> 请同学选择适当的题目完成，在命题中的功能性和美观性题目中分别各选择至少一个命题来实现（即在功能性题目中至少选择一个题目、美观性题目中至少选择一个题目）。
>
