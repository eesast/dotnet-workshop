...
namespace LogParser.Parser
{
    internal static class LineParser
    {
        ...
        private static LogEntry CreateInternal(LogRecord logRecord)
        {
            ...
            var separator = internalMessage.Exception.IndexOf(": ");
            if (separator < 0)
            {
            ...
            return new InternalLogEntry(
                ...
                ExceptionName: internalMessage.Exception.Substring(0, separator),
                ExceptionMessage: internalMessage.Exception.Substring(separator + 2)
            );
        }
