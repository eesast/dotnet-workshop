...
随着 Coding Agent 的迅速发展，截止今日（2026.7），使用先进的大模型已经能轻松完成本项目的大部分内容。要求同学们手动完成作业既浪费过多时间，又难以进行监管。暑培允许使用 AI 辅助完成作业，但需遵循如下的几条限制：
- 应先在 AI 协助下理解项目整体框架，并挑选你觉得重要部分的代码进行仔细阅读
